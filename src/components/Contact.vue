<template>
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form id="contactForm" method="post" @submit.prevent="onSub" name="sentMessage" novalidate="novalidate">
            <div class="row">
              <div class="col-md-6">
    ...
    export default {
        ...
        methods: {
            onSub(){
                ...
                alert(response => (this.info = response.data.bpi));

                // this.$axios.get('./../../mail/contact_me.php', {
                //     name:   this.name,
                //     email:  this.email,
                //     phone:  this.phone,
